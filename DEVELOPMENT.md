...
### v2.9.12 - Frame Info in Time Display
- Removed black "Frame/Time" bar at top right
- Frame number now shows in bottom time display
- Format: "Frame: 123 | 00:04.100 / 01:00.000"
...
- Portrait: DELETE only on right side (large circle, muted red)
- KEEP and MOVE hidden in portrait mode
- Landscape: unchanged (all buttons on right)

### v2.9.9 - Edit List Stripe Compression
- Edit list frames now compress to always fit on screen
- Frame width scales down as more clips are added
- Minimum frame width of 4px prevents them becoming invisible
- No more running off the edge of the screen
